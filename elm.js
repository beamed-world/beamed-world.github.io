...
var _user$project$Main$containerClass = 'col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3';
var _user$project$Main$containerWrap = function (children) {
	return A2(
...
var _user$project$Main$footerSection = A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html$text('flexboxgrid')
												])),
											A2(
											_elm_lang$html$Html$li,
											_elm_lang$core$Native_List.fromArray(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html$text('normalize.css')
												])),
											A2(
											_elm_lang$html$Html$li,
											_elm_lang$core$Native_List.fromArray(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html$text('typebase.css')
												])),
											A2(
											_elm_lang$html$Html$li,
											_elm_lang$core$Native_List.fromArray(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html$text('Source Code Pro')
												]))
										]))
								]))
						]))
...
var _user$project$Main$mainSection = A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 main')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html$text('Main Title')
												])),
											A2(
											_elm_lang$html$Html$p,
											_elm_lang$core$Native_List.fromArray(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html$text('Article Title')
												])),
											A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Different Title')
										])),
									A2(
									_elm_lang$html$Html$h3,
									_elm_lang$core$Native_List.fromArray(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Different text')
										])),
									A2(
									_elm_lang$html$Html$p,
									_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$headerSection = function () {
	var heading = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'col-xs')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Beamed World')
					]))
			]));
	return A2(
	...
	main: A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$mainSection,
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
